...
import { ArrowDown, Users, Settings, Shield } from 'lucide-react';
import { scrollToSection } from '../utils/navigation';
import { supabase } from '../lib/supabase';

const TransitionToManagement: React.FC = () => {
  ...
  return (
    <section className="py-16 bg-gradient-to-br from-emerald-600 to-emerald-800 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-12 left-12 w-36 h-36 border border-white rounded-full"></div>
        <div className="absolute bottom-12 right-12 w-24 h-24 border border-white rounded-full"></div>
        <div className="absolute top-2/3 left-1/3 w-18 h-18 border border-white rounded-full"></div>
      </div>
...
export default TransitionToManagement;